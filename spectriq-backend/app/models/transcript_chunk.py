...
class TranscriptChunk(Base):
    ...
    # Dimension must match JINA_EMBEDDING_DIM (jina-embeddings-v3's native
    # output size, 1024 by default). If you change the model or dimension,
    # this column needs a migration + a full re-index of existing meetings.
    embedding = Column(Vector(settings.JINA_EMBEDDING_DIM), nullable=False)
